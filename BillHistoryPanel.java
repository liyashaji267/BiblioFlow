...
public class BillHistoryPanel extends JPanel {
    ...
    // --------------------------------------------------
    // MAIN TABLE (BILL LIST)
    // --------------------------------------------------
    private void initMainTable(JPanel mainPanel) {
        ...
        // ✅ FIX: add to mainPanel, not directly to BillHistoryPanel
